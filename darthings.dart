...
1. Install HomeBrew
2. In terminal
a. brew tap dart-lang/dart
b. brew install dart
c. brew tap dart-lang/dart
d. brew install dart --with-content-shell --with-dartium
3. Set up Package Control by typing the code on this site
https://packagecontrol.io/installation into your console
4. In Sublime Tools - Command Palette and type install
5. Click Install Package and type Dart and click on Dart
6. Get SDK location by typing in terminal brew --prefix
7. In Sublime Preferences - Settings User and in Sublime
Preferences - Package Settings -Dart put this line
"dart_sdk_path": "/usr/local/opt/dart/libexec",
8. Create file pubspec.yaml and add the following
name: my_project
version: 0.0.1
description: My project.
Save your project
9. Shift - F7 to run the current file
*/
